...
const skills = [
  ...
  { name: "React", icon: <FaReact className="text-blue-400 text-3xl" />, level: "85%" },
  ...
  { name: "MongoDB", icon: <FaDatabase className="text-green-700 text-3xl" />, level: "95%" },
...
{/*             
      ...
      {/* Skills Section */}
      <div className="container mx-auto px-6 py-20 ">
      <h2 className="text-3xl font-bold mt-16 text-center text-white">Skills</h2>
      ...
      {/* Projects Section */}
      </div> {/* Closing Skills Section */}
      <div className="border-t border-gray-200 "></div>
      <div className=" py-20">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl font-bold text-center mb-4 text-white">WORKS</h2>
