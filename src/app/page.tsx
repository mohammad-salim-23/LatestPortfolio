          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            >
              <div className="relative w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden border-4 border-teal-500">
                <Image src="/salim1.jpg" alt="Salim Hossain" width={300} height={300} />
              </div>
            </motion.div>
          </div>
        </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="text-center">
                ...
                <Image src="/swapnoferi.jpg" alt="Leadership Icon" width={300} height={300} className="mx-auto object-contain" />
              ...
              <div className="text-center">
                ...
                <Image src="/presenTation.jpeg" alt="Presentation Icon" width={300} height={300} className="mx-auto object-contain" />
                <p className="text-white mt-2 text-sm md:text-base">
