...
const LoginPage = () =>{
    ...
    return (
        <div className="my-10 w-[90%] mx-auto mt-24 lg:mt-22">
          ...
          <div className="w-[80%] mx-auto bg-white p-6 shadow-lg rounded-lg">
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div>
                <button
                  type="submit"
                  className="w-full border border-teal-500 text-teal-500 font-semibold py-2 px-4 rounded-md shadow-md hover:bg-teal-500 hover:text-black cursor-pointer"
                >
                  Login
                </button>
              </div>
            ...
            <div className="flex justify-center gap-4 mt-4">
              ...
              onClick={() =>
                signIn("google", {
                  callbackUrl: "https://nextjs-authentication-starter-pack-tan.vercel.app/dashboard",
                })
              }
    ...
    onClick={() =>
     signIn("github",{
        callbackUrl: "http://localhost:30003",
     })
    }
    className="flex items-center justify-center w-12 h-12 bg-gray-100 rounded-full shadow-md hover:bg-gray-200"
  >
