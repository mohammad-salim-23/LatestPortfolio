  ...
  return (
    <div className="p-6 mt-20 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
        ...
        />
        <div>
          <p className="whitespace-pre-line text-gray-700 mb-4">{project.description}</p>
          <div className="flex flex-col gap-3">
            <a href={project.live_link} target="_blank" className="text-blue-600 underline font-semibold">
              🔗 Live Preview
            </a>
            <a href={project.client_side_link} target="_blank" className="text-green-600 underline font-semibold">
              💻 Client Code
            </a>
            <a href={project.server_side_link} target="_blank" className="text-purple-600 underline font-semibold">
              🖥️ Server Code
            </a>
          </div>
        </div>
